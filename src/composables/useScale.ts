...
const criteriaFemale: Criterion[] = [
  { id: 1, name: 'Верность и порядочность (Базис)', description: 'Отношение к изменам, наличие бывших в активном доступе, чистоплотность в общении с мужчинами.' },
...
const criteriaMale: Criterion[] = [
  ...
  { id: 4, name: 'Воспитанность и подача', description: 'Без хвастовства, пошлости и «крутости»; уважение к людям и к партнёрше на людях.' },
  { id: 5, name: 'Голова и диалог', description: 'Умеет слушать, признавать ошибки и договариваться, а не настаивать на своём любой ценой.' },
  { id: 6, name: 'Внешность и мужественность', description: 'Ухоженность, осанка, физическая форма, стиль и адекватная самооценка — без перекосов в нарциссизм.' },
